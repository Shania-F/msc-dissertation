...
def train_model(save_name='KingsCollege'):
    ...
    model = models.ResNetV(fixed_weight=False)
    model.to(device)
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for i, (inputs, poses) in enumerate(train_loader):
            ...
            print('{}th train Loss: total loss {:.3f} / pos loss {:.3f} / ori loss {:.3f}'.format(i, loss_print,
                                                                                               loss_pos_print,
                                                                                               loss_ori_print))
        ...
        for i, (inputs, poses) in enumerate(val_loader):
            ...
            print('{}th val Loss: total loss {:.3f} / pos loss {:.3f} / ori loss {:.3f}'.format(i, loss_print,
                                                                                              loss_pos_print,
                                                                                               loss_ori_print))
