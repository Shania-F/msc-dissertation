...
class GoogleNet(nn.Module):
    ...
    def __init__(self, fixed_weight=False, dropout_rate=0.0):
        ...
        base_model = models.inception_v3(pretrained=True)  # from torchvision models
        self.dropout_rate = dropout_rate
    ...
    def forward(self, x):
        ...
        # self.training is set to False in eval mode, here we set it explicitly
        # 1 x 1 x 2048
        x = x.view(x.size(0), -1)
        # 2048
        pos = self.pos2(x)
...
if __name__ == '__main__':
    ...
    # model2 = ResNet(fixed_weight=True)
    # summary(model2, (3, 224, 224))

    model3 = ResNetV(fixed_weight=True)
